...
func (r *TrackMetadataRepo) Upsert(ctx context.Context, meta domain.TrackMetadata) error {
	...
	(track_hash, uploaded_by, bpm, tonality, comments, remixer, label, mix, genre, composer,
		date_added, play_count, rating, cue_points, beatgrid)
...
func (r *TrackMetadataRepo) GetForTrack(ctx context.Context, trackHash string, uploadedBy uuid.UUID) (*domain.TrackMetadata, error) {
	query := `SELECT track_hash, uploaded_by, bpm, tonality, duration_seconds, comments, remixer,
	label, mix, genre, composer, sample_rate, date_added, play_count, rating, bitrate, cue_points, beatgrid, created_at
...
func (r *TrackMetadataRepo) ListUploadersForTrack(ctx context.Context, trackHash string) ([]domain.TrackMetadata, error) {
	...
	label, mix, genre, composer, date_added, play_count, rating, cue_points, beatgrid, created_at
